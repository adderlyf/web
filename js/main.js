$(window).load(function() {
    ...
    $('.item img').each(function() {
        ...
        el.css({
            "position": "relative"
        }).wrap("<div class='img_wrapper' style='position: relative;'>").clone().addClass('img_grayscale').css({
            "position": "absolute",
            "z-index": "998",
            "opacity": "0"
...
$("#work-portfolio:first a[rel^='prettyPhoto']").prettyPhoto({
    animation_speed: 'normal',
    theme: 'light_square',
    slideshow: 3000
});
$("#work-portfolio:gt(0) a[rel^='prettyPhoto']").prettyPhoto({
    animation_speed: 'fast',
    slideshow: 10000,
    hideflash: true
});
$("#blog-list:first a[rel^='prettyPhoto']").prettyPhoto({
    animation_speed: 'normal',
    theme: 'light_square',
    slideshow: 3000
});
$("#blog-list:gt(0) a[rel^='prettyPhoto']").prettyPhoto({
    animation_speed: 'fast',
    slideshow: 10000,
    hideflash: true
});
$("#our-portfolio-col-info:first a[rel^='prettyPhoto']").prettyPhoto({
    animation_speed: 'normal',
    theme: 'light_square',
    slideshow: 3000
});
$("#our-portfolio-col-info:gt(0) a[rel^='prettyPhoto']").prettyPhoto({
    animation_speed: 'fast',
    slideshow: 10000,
    hideflash: true
});
